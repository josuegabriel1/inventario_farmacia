...
<body>
								...
								<div class="panel panel-success">
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" onkeypress="return valideKeyLetter(event);" class="form-control" id="nombre" name="nombre" placeholder="Nombre"  tabindex="4" value="<?php echo $nombre; ?>" required="">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text"  maxlength="9" class="form-control" id="telefono" name="telefono" placeholder="1234-5678"  autofocus="" tabindex="6" value="<?php echo $telefono; ?>" required="" >
											</div>
										</div>
	...
	function validar(){
		...
		var campos = 'fecha,num_expediente,direccion,responsable,antecedentes,fc,spo2,Peso,tratamiento,edad,nombre,telefono,consulta,ta,t,hgt,diagnostico'
...
//Función que valida en las cajas de texto, que entra y que no.
//Permite letras y tíldes en minúsculas y mayúsculas. 
//No permite ingresar números y símbolos.
